...
TEST(SimpsonTaskStlTest, OneDimensionalIntegral) {
...
TEST(SimpsonTaskStlTest, TwoDimensionalIntegral) {
  using namespace korobeinikov_simpson_multidim;
...
TEST(SimpsonTaskStlTest, ThreeDimensionalIntegral) {
  using namespace korobeinikov_simpson_multidim;
