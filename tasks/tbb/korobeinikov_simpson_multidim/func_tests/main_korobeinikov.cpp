...
TEST(SimpsonTaskTbbTest, OneDimensionalIntegral) {
...
TEST(SimpsonTaskTbbTest, TwoDimensionalIntegral) {
  using namespace korobeinikov_simpson_multidim;
...
TEST(SimpsonTaskTbbTest, ThreeDimensionalIntegral) {
  using namespace korobeinikov_simpson_multidim;
