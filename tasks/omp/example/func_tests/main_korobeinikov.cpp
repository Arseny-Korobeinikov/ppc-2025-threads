...
TEST(SimpsonTaskOmpTest, OneDimensionalIntegral) {
...
TEST(SimpsonTaskOmpTest, TwoDimensionalIntegral) {
  using namespace korobeinikov_simpson_multidim;
...
TEST(SimpsonTaskOmpTest, ThreeDimensionalIntegral) {
  using namespace korobeinikov_simpson_multidim;
