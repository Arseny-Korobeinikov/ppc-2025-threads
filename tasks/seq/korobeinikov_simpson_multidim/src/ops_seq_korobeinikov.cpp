...
bool korobeinikov_simpson_multidim::SimpsonTaskSeq::ValidationImpl() {
...
bool korobeinikov_simpson_multidim::SimpsonTaskSeq::PreProcessingImpl() {
...
bool korobeinikov_simpson_multidim::SimpsonTaskSeq::RunImpl() {
  double isum = 0.;
...
bool korobeinikov_simpson_multidim::SimpsonTaskSeq::PostProcessingImpl() {
